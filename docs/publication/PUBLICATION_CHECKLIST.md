...
| P0 | Public bootstrap content review | done | Release agent + Human/project owner | [`server_tools/public_bootstrap/REVIEW.md`](../../server_tools/public_bootstrap/REVIEW.md) passes for 37 schema tables, 22 seed tables, and 824 counted fixture rows; the reviewed beta scope now includes the complete First Run environment, verification, identity, and credential flow. |
